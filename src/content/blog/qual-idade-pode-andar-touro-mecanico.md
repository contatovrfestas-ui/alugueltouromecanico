...
tags: ['idade', 'segurança', 'NBR-16071', 'limite-peso']
relatedEventos: ['aniversario-infantil', 'festa-junina', 'aniversario-18']
---

Família que vai contratar touro mecânico pra festa com público misto sempre faz a pergunta: **"meu filho de 5 anos pode andar?"** ou **"minha mãe de 60 anos pode tentar?"**. A resposta depende do **modelo do equipamento** e da **condição física do usuário**, não da idade nominal isolada.

Esse post mostra as faixas etárias por modelo, peso máximo, condições de saúde que contraindicam, e por que o operador profissional pode recusar usuário mesmo dentro da idade.

## A tabela mestra: idade por modelo
...
A partir dos **20-30 anos**, o público típico é o que pede **modo forte** — a graça é tentar o limite. [Festas universitárias](/blog/touro-mecanico-festival-universitario-rio/), [aniversários 18-25](/aluguel-touro-mecanico/aniversario-18/), [despedidas de solteiro](/aluguel-touro-mecanico/despedida-solteiro/) operam predominantemente nesse perfil.
...
Independente da idade dentro da faixa, a operação **é recusada** quando o usuário declara ou apresenta:

- **Gestação** — qualquer trimestre, sem exceção
- **Hipertensão não controlada** — risco de pico durante aceleração
- **Cardiopatia conhecida** — arritmia, marcapasso, válvula mecânica
- **Cirurgia cardíaca/abdominal/coluna nos últimos 6 meses**
- **Hérnia de disco lombar** ou cervical em fase aguda
- **Lesão no joelho ou tornozelo** sem alta médica
- **Prótese ortopédica** (quadril, joelho) sem autorização médica explícita
- **Tontura, vertigem ou labirintite** em crise
- **Embriaguez evidente** — risco de queda inadequada

Em [festa empresa](/aluguel-touro-mecanico/festa-empresa/) ou evento corporativo, é prática a empresa pedir **termo de declaração de saúde** assinado pelo participante antes de subir. Em festa privada, o operador pergunta diretamente.
...
3. **Comportamento inadequado** — usuário tentando subir com colega no colo, sem se segurar, ignorando orientação

Cliente que tenta forçar a operação assina **termo de exclusão de responsabilidade** ou perde o turno. A empresa cobre o operador.

## Festa de aniversário infantil: organização da fila por idade
...
Em [festa junina](/aluguel-touro-mecanico/festa-junina/) ou festa familiar com público misto, geralmente o cliente contrata o **modelo profissional** com instrução pro operador alternar programa entre os usuários. A operação típica:

- **17h-19h** (criança presente): modo lento e super-lento, ciclo 30-45s
- **20h-22h** (depois das crianças saírem): modo médio e forte, adultos
- **22h em diante**: modo forte se grupo de adultos pedir

Modelo profissional cobre os dois extremos com bom critério do operador. **Modelo infantil simultâneo com profissional** funciona pra festa grande, mas dobra o custo.
