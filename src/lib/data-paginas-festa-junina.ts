...
export const PAGINAS_FESTA_JUNINA: IPagina[] = [
  ...
  montarPagina({
    ...
    faqs: [
      ...
      { p: 'Festa junina em casa de festa de aluguel em Jacarepaguá: pode?', r: 'Pode. As principais casas de festa do bairro (em Taquara, Curicica, Pechincha) já conhecem nosso material e aceitam touro mecânico mediante laudo INMETRO + apólice + ART. Entregamos toda a documentação ao gerente da casa em 24h.' },
